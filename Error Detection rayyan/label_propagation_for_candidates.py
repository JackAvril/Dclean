...
CLUSTER_CENTER_DIST_QUANTILE = 0.70
    ...
    with open(output_jsonl, "w", encoding="utf-8") as f:
        for _, row in df.iterrows():
            ...
            obj = {
                ...
                "canonical_rule_count": float(row["canonical_rule_count"]) if pd.notna(row["canonical_rule_count"]) else None,
