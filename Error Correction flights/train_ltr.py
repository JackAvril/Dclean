...
def parse_args():
    ...
    p.add_argument("--pairwise_responses", default="/mnt/mydata/dq/projects/Splittree/test/Error Correction flights/repair_pairwise_responses_v2.jsonl")
    p.add_argument("--output_dir", default="/mnt/mydata/dq/projects/Splittree/test/Error Detection flights/active_cleaning_loop_runs_v4/iter_3/infer/pairwise_ltr_student_output_flights")
