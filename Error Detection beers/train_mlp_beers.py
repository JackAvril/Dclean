...
STAGE1_NUMERIC_FEATURES = [
    ...
    "pattern_rule_count", "schema_rule_count", "numeric_window_rule_count", "numeric_value",
...
def add_derived_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    risk_cols = {"abv", "ibu", "ounces", "state", "style", "brewery_name", "city"}
...
def build_verifier_dataset(df: pd.DataFrame) -> pd.DataFrame:
    ...
    risk_col_fp_mask = fp_mask & col_series.isin(
        {"abv", "ibu", "ounces", "state", "style", "brewery_name", "city"}
    )
    ...
    sample_true_error_mask = (out["verifier_label"] == 1) & col_series.isin(["abv", "ibu", "ounces"])
