...
BASE_TRAIN_CSV = "final_train_dataset_movies.csv"
BASE_INFERENCE_CSV = "candidate_infer_ready_movies.csv"

TRAIN_SCRIPT_PATH = "train_mlp.py"
INFER_SCRIPT_PATH = "infer_mlp.py"

WORK_DIR = "active_cleaning_loop_runs_movies_v4"
...
SYSTEM_PROMPT = """
You are an expert data-cleaning annotator for movie metadata tables.
...
3. For movies, pay attention to Year/Release Date consistency, plausible Duration, RatingValue range, count formats, list fields, Actors-Cast overlap, and mojibake.
4. If neighbor evidence strongly supports the current value and no strong movie rule contradicts it, prefer correct.
