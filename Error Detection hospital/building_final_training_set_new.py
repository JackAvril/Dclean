...
# 是否优先保留候选内 correct，再保留候选外 correct
...
def build_candidate_training_from_labels(
    ...
    if KEEP_ALL_LLM_LABELED:
        for _, row in labeled_df.iterrows():
            ...
            # 用 labeled 覆盖 clustered 中可能缺失的新字段
            for extra_col in [
                "main_usage_role",
                "rare_value_count",
                "typo_rule_count",
...
def main():
    ...
    print("[3/6] Building outside-clean training set (simple version) ...")
